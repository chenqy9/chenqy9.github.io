var store = [{
        ...
        "url": "http://localhost:4000/%E6%96%87%E7%AB%A0%E6%95%99%E7%A8%8B/build-blog-with-jekyll-and-github-pages/",
        "teaser":null},{
        "title": "CAS入门",
        ...
        "tags": ["CAS","单点登录","入门"],
        "url": "http://localhost:4000/%E6%8A%80%E6%9C%AF%E6%96%87%E6%A1%A3/learn-about-cas/",
        "teaser":null},{
        "title": "CAS安装",
        ...
        "tags": ["CAS","单点登录","安装"],
        "url": "http://localhost:4000/%E6%8A%80%E6%9C%AF%E6%96%87%E6%A1%A3/cas-install/",
        "teaser":null},{
        "title": "Linux离线安装node",
        ...
        "tags": ["node","linux"],
        "url": "http://localhost:4000/%E6%8A%80%E6%9C%AF%E6%96%87%E6%A1%A3/linux-node-install/",
        "teaser":null},{
        ...
        "tags": ["linux","yarn"],
        "url": "http://localhost:4000/%E6%8A%80%E6%9C%AF%E6%96%87%E6%A1%A3/linux-yarn-install-offline/",
        "teaser":null},{
        "title": "Linux安装升级jenkins",
        "excerpt":"本文介绍在centos操作系统下通过yum安装jenkins，并通过下载官方war包的方式升级。 安装 安装JDK yum install -y java 安装Jenkins # 如果没安装wget，可先安装或用curl yum install -y wget # 添加Jenkins库到yum库 wget -O /etc/yum.repos.d/jenkins.repo http://pkg.jenkins-ci.org/redhat/jenkins.repo rpm --import https://jenkins-ci.org/redhat/jenkins-ci.org.key yum install -y jenkins 启动Jenkins服务 # 启动Jenkins service jenkins start # 停止Jenkins service jenkins stop # 重启Jenkins service jenkins restart 注意事项 Jenkins默认端口是8080，确保此端口不被占用或者修改Jenkins的默认端口，打开防火墙对该端口的拦截。 # 配置Jenkis的端口， 修改JENKINS_PORT=\"8080\"为目标端口 vi /etc/sysconfig/jenkins...","categories": ["文章教程"],
        "tags": ["jenkins","linuxÂ","yum"],
        "url": "http://localhost:4000/%E6%96%87%E7%AB%A0%E6%95%99%E7%A8%8B/linux-jenkins-install-yum/",
        "teaser":null}]
