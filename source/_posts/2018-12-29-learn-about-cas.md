...
CAS 没有官方支持的 servlet 容器，但[Apache Tomcat](http://tomcat.apache.org/)是最常用的。对特定 servlet 容器的支持取决于社区成员的专业知识，但已知以下工作正常并且应该获得[社区讨论邮件列表](https://apereo.github.io/cas/4.2.x/Mailing-Lists.html)的优先支持：
